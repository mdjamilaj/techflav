                ...
                <div class="card shadow">
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            <div class="col">
                                <h3 class="mb-0">Review Create</h3>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-12 mb-3">
                                <div class="form-group mb-1">
                                    ...
                                    <textarea class="form-control{{ $errors->has('review') ? ' is-invalid' : '' }}"
                                        id="review" name="review" rows="4">{{ old('review') }}</textarea>
                                </div>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 mb-3">
                                <div class="form-group mb-1">
                                    ...
                                    <textarea class="form-control{{ $errors->has('reply') ? ' is-invalid' : '' }}"
                                        id="reply" name="reply" rows="4">{{ old('reply') }}</textarea>
                                </div>
                                @if ($errors->has('reply'))
                                    <span class="invalid-feedback" style="display: block;" role="alert">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-3 mb-3">
                                <div class="form-group mb-1">
                                    ...
                                    <input placeholder="Customer" class="form-control" style="width: 100%" list="customerList" id="customerInput">
                                    <datalist id="customerList">
                                        @foreach ($customers as $customer)
                                            <option data-value="{{ $customer->id }}">{{ $customer->name }}</option>
                                        @endforeach
                                    </datalist>
                                    <input type="hidden" name="customer" id="customerInput-hidden">
                                </div>
