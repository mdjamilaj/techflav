                ...
                <div class="card shadow">
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            <div class="col">
                                <h3 class="mb-0">Product category update</h3>
                            </div>
                            <div class="col text-right">
                                <a href="{{ route('productCategory.index') }}" class="btn btn-sm btn-primary">View List</a>
                            </div>
                        </div>
                    </div>
                    <hr class="my-0">
                    <div class="p-4">
                        {!! Form::model($data, ['method' => 'PATCH', 'enctype' => 'multipart/form-data','route' => ['productCategory.update', $data->id]]) !!}
                        <div class="row">
