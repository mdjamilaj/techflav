...
<body class="clean-body" style="margin: 0; padding: 0; -webkit-text-size-adjust: 100%; background-color: #f3e6f8;">
    <!--[if IE]><div class="ie-browser"><![endif]-->
    <table class="nl-container"
        style="table-layout: fixed; vertical-align: top; min-width: 320px; border-spacing: 0; border-collapse: collapse; mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #f3e6f8; width: 100%;"
        cellpadding="0" cellspacing="0" role="presentation" width="100%" bgcolor="#f3e6f8" valign="top">
        <tbody>
            <tr style="vertical-align: top;" valign="top">
                <td style="word-break: break-word; vertical-align: top;" valign="top">
                    <!--[if (mso)|(IE)]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td align="center" style="background-color:#f3e6f8"><![endif]-->
                                        ...
                                        <div
                                            ...
                                            <div class="img-container center fixedwidth" align="center"
                                                ...
                                                <div style="font-size:1px;line-height:15px">&nbsp;</div><img
                                                    ...
                                                    src="{{ asset('logo.png') }}" alt="your logo" title="your logo"
                                        ...
                                        <div
                                            ...
                                            <div class="img-container center fixedwidth" align="center"
                                                ...
                                                <div style="font-size:1px;line-height:20px">&nbsp;</div><img
                                                    class="center fixedwidth" align="center" border="0"
                                                    src="https://d1oco4z2z1fhwp.cloudfront.net/templates/default/2971/lock4.png"
                                                    alt="Forgot your password?" title="Forgot your password?"
                                                    style="text-decoration: none; -ms-interpolation-mode: bicubic; height: auto; border: 0; width: 325px; max-width: 100%; display: block;"
                                                    width="325">
                                            ...
                                            <table cellpadding="0" cellspacing="0" role="presentation" width="100%"
                                                ...
                                                valign="top">
                                                <tr style="vertical-align: top;" valign="top">
                                                    <td style="word-break: break-word; vertical-align: top; padding-bottom: 0px; padding-left: 0px; padding-right: 0px; padding-top: 35px; text-align: left; width: 100%;"
                                                        width="100%" align="center" valign="top">
                                                        <h1
                                                            style="color:#8412c0;direction:ltr;font-family:'Cabin', Arial, 'Helvetica Neue', Helvetica, sans-serif;font-size:20px;font-weight:normal;letter-spacing:normal;line-height:120%;text-align:center;margin-top:0;margin-bottom:0;">
                                                            Hi, <strong>{{ $data['customer']->name }}</strong></h1>
                                                    </td>
                                                </tr>
                                            </table>
                                            <table cellpadding="0" cellspacing="0" role="presentation" width="100%"
                                                ...
                                                valign="top">
                                                <tr style="vertical-align: top;" valign="top">
                                                    <td style="word-break: break-word; vertical-align: top; padding-bottom: 0px; padding-left: 0px; padding-right: 0px; padding-top: 10px; text-align: center; width: 100%;"
                                                        width="100%" align="center" valign="top">
                                                        <h1
                                                            style="color:#8412c0;direction:ltr;font-family:'Cabin', Arial, 'Helvetica Neue', Helvetica, sans-serif;font-size:20px;font-weight:normal;letter-spacing:normal;line-height:120%;text-align:center;margin-top:0;margin-bottom:0;">
                                                            <strong>Here is the OTP code for your password reset in
                                                                techFlav</strong></h1>
                                                    </td>
                                                </tr>
                                            </table>
                                            ...
                                            <div
                                                ...
                                                <div class="txtTinyMce-wrapper"
                                                    ...
                                                    <p
                                                        style="margin: 0; text-align: center; line-height: 1.5; word-break: break-word; font-size: 18px; mso-line-height-alt: 27px; margin-top: 15px; margin-bottom: 10px;">
                                                        <span style="font-size: 18px; color: #aa67cf;margin-top:15px;">
                                                            <?php
                                                             $code = $data['code'];
                                                             $nstr = $code . "";
                                                             ?>
                                                            <?php for ($i = 0; $i < strlen($nstr); ++$i) { ?>
                                                                <span style="border: 1px solid;border-radius: 3px;padding: 4px 10px;margin: 0px 5px;"><?php echo $nstr[$i] ?></span>
                                                           <?php } ?>
                                                        </span></p>
                                                </div>
                                            </div>
                                            ...
                                            <div
                                                ...
                                                <div class="txtTinyMce-wrapper"
                                                    ...
                                                    <p
                                                        style="margin: 0; line-height: 1.5; word-break: break-word; font-size: 13px; mso-line-height-alt: 20px; mso-ansi-font-size: 14px; margin-top: 0; margin-bottom: 0;">
                                                        <span
                                                            style="font-size: 13px; color: #8412c0; mso-ansi-font-size: 14px;">If
                                                            you did reset your password than use the otp:</span></p>
                                                </div>
                                            </div>
                                            <!--[if mso]></td></tr></table><![endif]-->
                                            ...
                                            <div
                                                style="color:#393d47;font-family:'Cabin', Arial, 'Helvetica Neue', Helvetica, sans-serif;line-height:1.2;padding-top:10px;padding-right:10px;padding-bottom:70px;padding-left:10px;">
                                                <div class="txtTinyMce-wrapper"
                                                    ...
                                                    <p
                                                        ...
                                                        <span style="font-size: 10px; color: #aa67cf;"><span style>If
                                                                you didn't request to change your brand password,
                                                            </span><span style>you don't have to do anything. So that's
                                                                easy.</span></span></p>
                                                </div>
                                            </div>
                                            <!--[if mso]></td></tr></table><![endif]-->
